...
window.Modernizr = (function(window, document, undefined) {
      ...
      injectElementWithStyles(
        ...
        function(node, rule) {
          var style = document.styleSheets[document.styleSheets.length - 1],
            ...
            cssText =
              style.cssRules && style.cssRules[0]
          ...
          /*>>touch*/ Modernizr["touch"] =
            "ontouchstart" in window || hash["touch"].offsetTop === 9; /*>>touch*/
          /*>>csstransforms3d*/ Modernizr["csstransforms3d"] =
            hash["csstransforms3d"].offsetLeft === 9; /*>>csstransforms3d*/
          /*>>generatedcontent*/ Modernizr["generatedcontent"] =
            hash["generatedcontent"].offsetHeight >= 1; /*>>generatedcontent*/
    ...
    tests["flexbox"] = function() {
      ...
      function setPrefixedValueCSS(element, property, value, extra) {
        ...
        element.style.cssText =
          (property + prefixes.join(value + ";" + property)).slice(
            0,
            -property.length
          ) + (extra || "");
      }
      ...
      function setPrefixedPropertyCSS(element, property, value, extra) {
        element.style.cssText =
          prefixes.join(property + ":" + value + ";") + (extra || "");
      }
    ...
    tests["cssgradients"] = function() {
      ...
      setCss(
        (str1 + prefixes.join(str2 + str1) + prefixes.join(str3 + str1)).slice(
          0,
          -str1.length
        )
      );
    ...
    tests["smil"] = function() {
      return (
        !!document.createElementNS &&
        /SVG/.test(toString.call(document.createElementNS(ns.svg, "animate")))
      );
    };
    ...
    tests["svgclippaths"] = function() {
      ...
      return (
        !!document.createElementNS &&
        /SVG/.test(toString.call(document.createElementNS(ns.svg, "clipPath")))
      );
    };
      ...
      (function(win, doc) {
        ...
        iepp.getCSS = function(styleSheetList, mediaType) {
          ...
          while (++a < len) {
            ...
            if (printMedias.test(mediaType))
              cssTextArr.push(
                iepp.getCSS(styleSheet.imports, mediaType),
                styleSheet.cssText
              );
        ...
        iepp.parseCSS = function(cssText) {
          ...
          while ((rule = ruleRegExp.exec(cssText)) != null) {
            ...
            cssTextArr.push(
              (
                (filterReg.exec(rule[1]) ? "\n" : rule[1]) +
                rule[2] +
                rule[3]
              ).replace(elemRegExp, "$1.iepp_$2") + rule[4]
            );
          }
          return cssTextArr.join("\n");
        };
        ...
        iepp._beforePrint = function() {
          ...
          styleElem.styleSheet.cssText = iepp.parseCSS(
            iepp.getCSS(doc.styleSheets, "all")
          );
          iepp.writeHTML();
        };
    ...
    docElement.className =
      docElement.className.replace(/\bno-js\b/, "") +
